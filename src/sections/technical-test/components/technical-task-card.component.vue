      ...
      <div class="container">
        <div class="column">
          <div class="left-container">
            <button v-if="technicalTestDetail.progress === 'InProgress'" @click="$emit('update-progress', 'Earrings', technicalTestDetail.id)"><i class="pi pi-chevron-left"></i></button>
            <button v-else-if="technicalTestDetail.progress === 'Done'" @click="$emit('update-progress', 'InProgress', technicalTestDetail.id)"><i class="pi pi-chevron-left"></i></button>
          ...
          <div v-if="technicalTestDetail.progress === 'Earrings'" class="right-container">
            ...
            <button @click="$emit('update-progress', 'InProgress', technicalTestDetail.id)"><i class="pi pi-chevron-right"></i></button>
          </div>
          <div v-else-if="technicalTestDetail.progress === 'InProgress'" class="right-container">
            ...
            <button @click="$emit('update-progress', 'Done', technicalTestDetail.id)"><i class="pi pi-chevron-right"></i></button>
          </div>
